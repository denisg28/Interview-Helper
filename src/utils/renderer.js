...
const secureAppMain = document.querySelector('secure-app-main');

// Consolidated cheddar object - all functions in one place
const cheddar = {
    // Element access
    element: () => secureAppMain,
    e: () => secureAppMain,

    // App state functions - access properties directly from the app element
    getCurrentView: () => secureAppMain.currentView,
    getLayoutMode: () => secureAppMain.layoutMode,
