...
export class SecureAppMain extends LitElement {
    ...
    constructor() {
        super();
        var onboardingFlag = localStorage.getItem('onboardingCompleted');
    ...
    async handleAPIKeyHelp() {
        if (window.require) {
            const { ipcRenderer } = window.require('electron');
            await ipcRenderer.invoke('open-external', 'https://secure-app.com/help/api-key');
        }
    }
...
customElements.define('secure-app-main', SecureAppMain);
