            ...
            <div class="help-container">
                <div class="option-group">
                    <div class="option-label">
                        <span>Secure Desktop Assistant — Справка и горячие клавиши</span>
                    </div>
                    <div class="description" style="margin-bottom: 10px;">
                        Это приложение — <strong>Secure Desktop Assistant</strong> для продуктивной работы, встреч и презентаций.
                    </div>
